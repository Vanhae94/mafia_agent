...
const RightPanel = ({ phase, survivorCount, onNextTurn, onDiscuss, onEndDiscuss, onContinue }) => {
         ...
         <div className="space-y-3">
            {isFreeDiscussion ? (
               <>
                  <button
                     onClick={onContinue}
                     className="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg text-white font-bold shadow-lg shadow-green-500/20 hover:shadow-green-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button
                     ...
                     className="w-full py-3 bg-noir-800 border border-red-500/50 rounded-lg text-red-400 hover:bg-red-500/10 hover:text-red-300 hover:border-red-400 transition-colors flex items-center justify-center gap-2 text-sm cursor-pointer"
                  >
               ...
               <>
                  ...
                  <button
                     onClick={onDiscuss}
                     className="w-full py-3 bg-noir-800 border border-noir-600 rounded-lg text-gray-300 hover:text-white hover:border-gray-400 transition-colors flex items-center justify-center gap-2 text-sm cursor-pointer"
                  >
                     <Search className="w-4 h-4" />
                     논의하기
                  </button>
